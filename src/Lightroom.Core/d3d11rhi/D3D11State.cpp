...
namespace RenderCore
{
	...
	bool D3D11SamplerState::CreateSamplerState(const SamplerStateInitializerRHI& Initializer)
	{
		...
		VERIFYD3DRESULT(Impl->D3D11RHI->GetDevice()->CreateSamplerState(&SamplerDesc, Impl->SamplerStateHandle.GetAddressOf()));
		return Impl->SamplerStateHandle != nullptr;
	}
	...
	bool D3D11RasterizerState::CreateRasterizerState(const RasterizerStateInitializerRHI& Initializer)
	{
		...
		VERIFYD3DRESULT(Impl->D3D11RHI->GetDevice()->CreateRasterizerState(&RasterizerDesc, Impl->RasterizerState.GetAddressOf()));
		return Impl->RasterizerState != nullptr;
	}
	...
	bool D3D11BlendState::CreateBlendState(const BlendStateInitializerRHI& Initializer)
	{
		...
		VERIFYD3DRESULT(Impl->D3D11RHI->GetDevice()->CreateBlendState(&BlendDesc, Impl->BlendState.GetAddressOf()));
		return Impl->BlendState != nullptr;
	}
	...
	bool D3D11DepthStencilState::CreateDepthStencilState(const DepthStencilStateInitializerRHI& Initializer)
	{
		...
		VERIFYD3DRESULT(Impl->D3D11RHI->GetDevice()->CreateDepthStencilState(&DepthStencilDesc, Impl->DepthStencilState.GetAddressOf()));
		return Impl->DepthStencilState != nullptr;
	}
